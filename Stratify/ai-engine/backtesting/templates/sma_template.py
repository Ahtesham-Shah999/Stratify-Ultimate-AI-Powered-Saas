"""SMA (Simple Moving Average) Backtesting Template.

Uses pandas-ta sma() with fast and slow period crossover.
...
def backtest():
    ...
    try:
        ...
        # Calculate SMAs - fast (20) and slow (50)
        df['sma_fast'] = ta.trend.SMAIndicator(df['close'], window=20).sma_indicator()
        df['sma_slow'] = ta.trend.SMAIndicator(df['close'], window=50).sma_indicator()
        ...
        for i in range(50, len(df)):
            ...
            if i > 50:
                ...
                if position is None and prev_sma_fast <= prev_sma_slow and sma_fast > sma_slow:
                ...
                elif position is not None and prev_sma_fast >= prev_sma_slow and sma_fast < sma_slow:
