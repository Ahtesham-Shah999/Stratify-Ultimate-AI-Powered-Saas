"""Stochastic Backtesting Template.

Uses pandas-ta stoch() with %K and %D crossover.
...
def backtest():
    """Execute Stochastic-based backtest."""
    ...
    try:
        ...
        for i in range(14, len(df)):
            ...
            if i > 14:
                ...
                if position is None and prev_stoch_k <= prev_stoch_d and stoch_k > stoch_d:
                ...
                elif position is not None and prev_stoch_k >= prev_stoch_d and stoch_k < stoch_d:
